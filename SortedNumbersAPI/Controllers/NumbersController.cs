...
/*
 * Controller class which handles Post and Get commands
 */
...
namespace SortedNumbersAPI.Controllers
{
    ...
    public class NumbersController : ControllerBase
    {
        ...
        //this is where bonus is written. it takes input and sorts it 3 times using different algorithms and returns result.
